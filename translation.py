class Translation(object):
    START_TEXT = """ <b> Hi {} , \nI'm A Saber. A File Renamer+File To Video Converter Bot With Permanent Thumbnail And Custom Caption support!</b> \n

<b>Bot Maintained By: @trending_anime_series </b> \n 
"""

    BANNED_USER_TEXT = "Sorry!! But Mai Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @yameteee_yamete_kudasai For more Details.. " 
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @trending_anime_series ❤️</b>"
    ...
    ABOUT_ME = """<b>Meh : I am Artoria Pendragon.\n A Telegram File Renamer Bot Which Can Rename A Telegram Files. \n You Can Set Permanent Thumbnail For The File So You Don't Have To Send Custom Thumbs All The Time.\n \n i can also convert files into videos \n Feedback @yameteee_yamete_kudasai If You Found Meh Useful</b>"""
    HELP_USER = """Checkout The Available Commands Here \n\n Do Follow @trending_anime_series If You Find This Bot Usefull❤️"""
